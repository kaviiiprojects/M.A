      ...
      {!isLoading && !isPending && reportData && (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-px bg-zinc-200 border border-zinc-200 mb-8 rounded-sm overflow-hidden">
                ...
                <StatCard title="Total Bill Received" value={formatCurrency(reportData.summary.totalCashReceived)} icon={Landmark} />
    ...
    return (
        <Table>
            ...
            <TableBody>
                ...
                {/* Total Row */}
                <TableRow className="bg-zinc-50 border-t-2 border-zinc-200 font-bold hover:bg-zinc-50">
                    <TableCell>TOTAL</TableCell>
                    <TableCell className="text-center">-</TableCell>
                    <TableCell className="text-right font-mono text-base">{formatCurrency(totalRevenue)}</TableCell>
                </TableRow>
            </TableBody>
        </Table>
    );
