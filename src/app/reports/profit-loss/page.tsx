...
export default function ProfitLossPage() {
  ...
  const fetchProducts = useCallback(async (signal: AbortSignal) => {
    ...
    try {
    const res = await fetch('/api/products?limit=1000', { signal }); // Fetch enough for dropdown
  ...
  return (
    <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-12 pt-8 pb-12">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-12 gap-6">
            <div>
                <h1 className="text-4xl lg:text-5xl font-light tracking-tighter mb-3 text-zinc-900">PROFIT &amp; LOSS <br /><span className="!text-gray-600 !text-[2rem]">PRODUCTS</span></h1>
