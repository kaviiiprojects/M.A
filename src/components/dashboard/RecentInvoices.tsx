...
type RecentInvoicesProps = {
  data: (Pick<WithId<Invoice>, 'id' | 'invoiceNumber' | 'paymentStatus' | 'date' | 'total'> & { customerName: string; customerPhone?: string })[];
};
                  ...
                  <TableRow key={invoice.id} className="border-zinc-100">
                    ...
                    <TableCell className="py-3 px-0">
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] text-zinc-500">{invoice.customerPhone}</span>
                      </div>
                    </TableCell>
                    <TableCell className="py-3 px-0">
                      <Badge 
