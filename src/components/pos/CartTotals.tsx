      ...
      <div className="px-10 py-2 bg-zinc-50 border-b border-t border-zinc-200">
        <div className="grid grid-cols-12 gap-4 text-xs uppercase tracking-widest text-zinc-400 font-medium">
          <div className="col-span-5 flex items-center gap-2">
            ...
            <button onClick={onAddCustomJob} title="Add custom job" className="text-zinc-400 hover:text-black transition-colors hidden">
        ...
        <div className="space-y-3 mb-6">
          ...
          <div className="flex justify-between items-center text-sm">
            ...
            <div className="flex items-center gap-2">
              <Input
                className="w-16 text-right bg-transparent border-b border-zinc-200 focus:border-black outline-none font-mono text-zinc-500 focus:text-black"
                placeholder="0"
                type='number'
